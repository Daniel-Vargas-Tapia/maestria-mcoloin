  ...
  return (
    <nav>
      <ul>
        ...
        <li><button onClick={() => sectionHandler('nucleo_academico')} className={section === 'nucleo_academico' ? styles.active : ''}><IconUsersGroup /><span>Nucleo Academico</span></button></li>
      </ul>
    </nav>
  )
}
